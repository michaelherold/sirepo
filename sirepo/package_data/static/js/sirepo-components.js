...
/**
 * A <div> encapsulating a standard field
 */
class SRField extends SIREPO.DOM.UIDiv {
...
class SRPanelHeading extends SIREPO.DOM.UIDiv {
    ...
    constructor(id, title, controls=null) {
        ...
        this.toggleButton = new SRAnchorButton(null, null, this.doToggle);
        this.isHidden = true;
...
/**
 * An anchor (<a>) element with a child icon instead of text
 */
class SRAnchorButton extends SIREPO.DOM.UIAnchor {
    constructor(id, href, title, onclick, icon=null) {
        super(id, href, title, onclick);
...
class SRPanel extends SIREPO.DOM.UIDiv {
    ...
    constructor(id, title='') {
        ...
        this.heading.addChild(this.body);
        ...
        this.addClasses('panel panel-info');
        this.panelHeading = new SRPanelHeading();
 ...
 */
class SRReport extends SIREPO.DOM.UIDiv {
    ...
    constructor(id, modelName, displayType) {
        ...
        this.plot = new SIREPO.DOM.UIDiv(null, [
            new SIREPO.DOM.UIAttribute('data-model-name', this.modelName),
 ...
 * 3d report
 */
class SRReport3D extends SRReport {
    /**
 ...
 * Heatmap report
 */
class SRReportHeatmap extends SRReport {
    /**
     * @param {string} [id] - id for this report
     * @param {string} modelName - name of the model for this report
     */
